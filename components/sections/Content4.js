    ...
    const { response: insuranceType, error } = useAxios({
        method: "get",
        url: "/api/region/",
        headers: {
        "Content-Type": "application/json",
                ...
                <div className="fom_tab_box custom_tabs type_three">
                    ...
                    <div className="contentbox ">
                        ...
                        <div className="mr_top_20 pd_top_20">
                            ...
                            <div className="not-style success">{t("Success")}</div>
                            )}
                            {submissionStatus === "error" && <div className="not-style error">{t("Error")}</div>}
                        </div>
                        </div>
                    </div>
                    </div>
