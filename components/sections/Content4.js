...
export default function Content4() {
    ...
    return (
        <>
            <section id="request" className="content-section bg_op_1 position-relative" style={{ backgroundImage: 'url(assets/images/bg-3.jpg)' }}>
                {/*-============spacing==========-*/}
                                        ...
                                        <div className="contact_form_shortcode">
                                            <form onSubmit={handleSubmit}>
                                                <div className="row">
                                                    ...
                                                    <div className="col-lg-6">
                                                        <label>{t("Phone number")} <span>*</span></label>
                                                        <input type="tel" name="phone_number" placeholder="+996999999999" required
                                                    ...
                                                    <div className="col-lg-12">
                                                        ...
                                                        {/*-============spacing==========-*/}
                                                        <button type="submit">{t("Leave a request")}</button>
                                                    </div>
                                                </div>
                                            </form>
                                        </div>
